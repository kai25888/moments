FROM swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/library/node:20.19.1-bookworm AS front
WORKDIR /app
...
FROM swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/library/golang:1.23.3-alpine AS backend
ARG VERSION
ARG COMMIT_ID
WORKDIR /app
